...
public class PersonBasicInfo extends BaseScheduleJob {
    ...
    protected void businessExecute(JobExecutionContext context) {
        ...
        generatorContent(content, systemProject, projectId);
        if (!content.isEmpty()) {
            content.append("]]]");
    ...
    private void generatorContent(StringBuilder content,SystemProject systemProject,String projectId) {
